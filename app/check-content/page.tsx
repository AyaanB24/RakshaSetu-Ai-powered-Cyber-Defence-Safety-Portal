  ...
  return (
    <UserShell>
      <div className="space-y-6">
        <div>
          <h1 className="text-2xl md:text-3xl font-bold text-foreground">Check Suspicious Content</h1>
          <p className="mt-1 text-sm md:text-base text-muted-foreground">AI-powered threat detection and analysis</p>
        </div>
